            ...
            if line[0] != "@":
                ...
                if chr != "*":
                    ...
                    if flag == "0":
                        ...
                        base_quality_dict[id] = [chr, start, reference_dict[chr][start - 1:start + len(new_seq) - 1],
                                                 "|".join([str(x) for x in mapped_base_quality_list])]
...
def get_signal(fast5_path):
    ...
    """
    try:
        signal, sequence, signal_start, signal_length = get_events(fast5_path, args.basecall_group,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--basecall_group', default="RawGenomeCorrected_001",
